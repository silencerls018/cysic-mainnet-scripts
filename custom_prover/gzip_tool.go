...
// gzip_tool: Compress a file using Go's gzip (level -1) and output base64
// This ensures byte-for-byte compatibility with the official prover's gzip output
//
// Build: go build -o gzip_tool gzip_tool.go
// Usage: gzip_tool <file_path>
// Output: base64-encoded gzip data (printed to stdout)
